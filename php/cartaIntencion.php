          ...
          <?php
           ...
           ?>
				...
				<div class="col-md-10 col-md-offset-2">
					<label for="apellidos" class="col-md-13">A continuación descargar la carta intencion imprimela, firmala, escaneala y mandala en formato pdf (Tu archivo no tiene que pesar mas de 1 MB)</label>
